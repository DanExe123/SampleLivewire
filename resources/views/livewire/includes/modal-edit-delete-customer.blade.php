    ...
    <div x-data="{ open: false }" class="relative">
        ...
        <div x-show="open" @click.away="open = false" x-transition  x-cloak
            ...
            <ul class="py-1 text-sm text-gray-700">
                <li>
                    <a wire:navigate href="{{ route('edit-product', $customer->id) }}" 
                ...
                <li>
                    <button 
                        onclick="confirm('Are you sure you want to delete this product {{ $customer->id }} ?') ? '' : event.stopImmediatePropagation()" 
